...
const about = {
    title: 'About me',
    description: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas id obcaecati nihil, sint repudiandae maiores laboriosam ad.",
    info: [
        {
            fieldName: "Name",
            fieldValue: "syed bilal ali"
        },
        {
            fieldName: "Phone",
            fieldValue: "(+92) 3308466210"
        },
        {
        ...
        {
            fieldName: "Email",
            fieldValue: "bsyed0184@gmail.com"
        },
        {
            fieldName: "Freelance",
...
const education = {
    ...
    items: [
        {
            institutions: "Online Course Platform",
            degree: "Full Stack Web Development Bootcamp",
            duration: "2023",
        },
        {
            institutions: "Codecademy",
        ...
        {
            institutions: "Tech Institute",
            degree: "Certified Web Developer",
            duration: "2019",
        },
        {
            institutions: "Design School",
                                ...
                                <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[38px]">
                                    {education.items.map((item, index)=> {
                                        return (
                                            <li key={index} className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-center items-center lg:items-start gap-1">
                                                <span className="text-accent">{item.duration}</span>
                                                <h3 className="text-xl max-w-[260px] min-h-[68px] text-center lg:text-left">{item.degree}</h3>
                                                <div className="flex items-center gap-3">
                                                    {/* dot */}
                                                    <span className="w-[6px] h-[6px] rounded-full bg-accent"></span>
